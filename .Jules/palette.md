...
## 2024-10-25 - Scroll-Driven Dynamic ARIA Synchronization
**Learning:** Relying only on click events to set aria-current creates accessibility bugs when users scroll manually.
