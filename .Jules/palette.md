...
## 2024-10-24 - Dynamic ARIA synchronization with IntersectionObserver
**Learning:** Relying only on click events to set aria-current creates accessibility bugs when users scroll manually on single-page scrolling sites.
